...
function Navbar(props) {
  ...
  <button type="button" className="btn btn-secondary dropdown-toggle" id="dropdown-button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    Action
  </button>
  <div className="dropdown-menu">
    <a className="dropdown-item" href="#">Saree</a>
    <div className="dropdown-divider"></div>
    <a className="dropdown-item" href="#">Salwar</a>
    <div className="dropdown-divider"></div>
 ...
 function CartIcon() {
    return (
            ...
            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-cart3" fill="#039dfc" xmlns="http://www.w3.org/2000/svg">
...
function SearchIcon() {
    return (
        <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-search" fill="#039dfc"xmlns="http://www.w3.org/2000/svg">
...
function WishList() {
    return(
        <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-bookmark-heart" fill="#039dfc" xmlns="http://www.w3.org/2000/svg">
...
function UserLoginIcon() {
    return(
        <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-person-circle" fill="#039dfc" xmlns="http://www.w3.org/2000/svg">

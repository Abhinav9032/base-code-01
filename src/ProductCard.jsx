...
function ProductCard(props) {
  ...
  useEffect(() => {
    ...
    const url = APP_CONSTANTS.HTTP_PROTOCOL+APP_CONSTANTS.LOCAL_URL+APP_CONSTANTS.PRODUCTS_ENDPOINT;
    ...
    return(
        ...
        <div className="card card-product">
          <div className="card-image">
            <a href="#">
              {" "}
              <img className="img" src={props.imageUrl} id="card-image-custom"/>{" "}
            </a>
          </div>
          <div className="table">
